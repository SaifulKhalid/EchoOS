...
export async function fetchNotes(uid: string): Promise<NoteEntry[]> {
  ...
  try {
    ...
    throw new Error(`Failed to fetch notes: ${(err as Error).message}`, { cause: err });
  }
}
...
export async function addNote(
  ...
  try {
    ...
    throw new Error(`Failed to add note: ${(err as Error).message}`, { cause: err });
  }
}
...
export async function updateNote(
  ...
  try {
    ...
    throw new Error(`Failed to update note: ${(err as Error).message}`, { cause: err });
  }
}
...
export async function deleteNote(uid: string, id: string): Promise<void> {
  ...
  try {
    ...
    throw new Error(`Failed to delete note: ${(err as Error).message}`, { cause: err });
  }
}
